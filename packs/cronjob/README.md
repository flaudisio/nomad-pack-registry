...
| <a name="input_periodic"></a> [periodic](#input\_periodic) | Periodic block configuration | <pre>object(<br/>    {<br/>      enabled          = bool<br/>      crons            = list(string)<br/>      time_zone        = string<br/>      prohibit_overlap = bool<br/>    }<br/>  )</pre> | n/a | yes |
