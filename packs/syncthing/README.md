...
| <a name="input_traefik_http_headers"></a> [traefik\_http\_headers](#input\_traefik\_http\_headers) | Map of HTTP headers to be passed by to the service | `map(string)` | `{}` | no |
| <a name="input_traefik_route_host"></a> [traefik\_route\_host](#input\_traefik\_route\_host) | The Traefik router host | `string` | `""` | no |
| <a name="input_traefik_route_path"></a> [traefik\_route\_path](#input\_traefik\_route\_path) | The Traefik router patht | `string` | `""` | no |
