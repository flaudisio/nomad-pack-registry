...
| <a name="input_postgres_shutdown_delay"></a> [postgres\_shutdown\_delay](#input\_postgres\_shutdown\_delay) | Duration to wait when stopping Postgres tasks | `string` | `"3s"` | no |
